    ...
    <div class="full_width_wrap">
        ...
        <div class="live_share_head" data_usr_id="{{ $user ? $user->id  : ''}}">
            ...
            <ul>
                ...
                <li><strong>Expires in:</strong> <span id="liveShareCountdown" data_countto="{{ $expiry_time }}">--</span>
                </li>
            </ul>
        </div>
        @if(!empty($all_trades) && $user)
            @php
                    ...
                    <div
                            ...
                            <div class="flex flex-wrap items-center gap-3 max-md:w-full">
                                ...
                                <div
                                    ...
                                    <div class="search-wrap">
                                        ...
                                        <input aria-label="Search" id="trade_search" type="text" placeholder="Search"
                                            tabindex="0"
                        ...
                        <div class="no_trades_wrapper flex items-center justify-center overflow-hidden px-8 py-20"
                            ...
                            <div class="mx-auto flex w-full max-w-lg flex-col items-center justify-center">
                                ...
                                <main class="z-10 mb-6 flex w-full max-w-88 flex-col items-center justify-center gap-1">
                                    ...
                                    <p class="text-center text-sm text-tertiary">Try adjusting your search or filters to see
                                        more
                        ...
                        @endif>
                            <table class="global-table trades_journal_table">
                                ...
                                <tbody>
                                    @php
                                        echo view('components.journalRows', ['all_trades' => $all_trades, 'currency' => $currency, 'no_actions' => true]);
                                    @endphp
                                </tbody>
                            ...
                            <nav aria-label="Pagination" class="hidden items-center gap-3 md:flex ">
                                ...
                                <div class="hide_for_capture">
                                    <button {{ $total_pages <= 1 ? 'disabled' : '' }}
                                        class="btn btn-sm btn-secondary next_journal_page"
                                        data_total_pages="{{ $total_pages }}">
