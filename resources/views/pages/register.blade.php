  ...
  <section class="grid min-h-screen grid-cols-1 overflow-hidden bg-primary lg:grid-cols-2">
    ...
    <div class="flex flex-col bg-primary">
        ...
        <div class="flex w-full flex-col gap-8 sm:max-w-90">
          <div class="flex flex-col items-center gap-6 text-center">
            ...
            <div class="flex flex-col gap-2 md:gap-3">
              <h1 class="text-xl font-semibold text-primary md:text-display-xs">Create an account</h1>
              <p class="text-md text-tertiary">Create your account to log trades, analyze your performance, and improve with every trade.</p>
            </div>
          </div>

          <form class="relative flex flex-col gap-6" id="register_form">
            @csrf
            ...
            <div class="flex flex-col gap-5">
              ...
              <div class="group flex h-max w-full flex-col items-start justify-start gap-1.5">
                ...
                <label class="form-label" data-label="true">Name<span class="text-brand-tertiary">*</span>
                </label>

                <input type="text" required="" placeholder="Enter your name" tabindex="0" class="form-input"
                  name="full_name" value="" title="">
          ...
          <div class="flex justify-center gap-1 text-center">
            <span class="text-sm text-tertiary">Already have an account?</span>
            <a class="group form-footer__link" href="/login" tabindex="0">
              <span data-text="true" class="transition-inherit-all">Sign in</span>
            </a>
          </div>
      ...
      <footer class="hidden p-8 pt-11 lg:block">
        <p class="text-sm text-tertiary">© Trade APP UI {{ date('Y') }}</p>
      </footer>
    </div>

    <div class="relative overflow-hidden max-lg:hidden">
      <img src="https://images.pexels.com/photos/7691769/pexels-photo-7691769.jpeg"
