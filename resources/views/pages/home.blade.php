        ...
        <div class="flex w-full flex-col flex-wrap gap-4 md:flex-row lg:gap-5">
            ...
            <div class="rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset lg:w-[25%] md:w-[35%] w-full grow">
                <div class="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        @else
                            <span class="text-sm font-medium text-tertiary">Net {{ isset($portfolioSummry['net_pnl']) && $portfolioSummry['net_pnl'] > 0 ? 'profit' : 'loss' }}</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset lg:w-[25%] md:w-[35%] w-full grow">
                <div class="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        @else
                            <span class="text-sm font-medium text-tertiary">of {{ $all_trades_count }} trades</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset lg:w-[25%] md:w-[35%] w-full grow">
                <div class="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                    ...
                    <div class="flex flex-col gap-3">
                        <p class="flex-1 text-display-sm font-semibold text-primary">{{ $all_trades_count }}</p>
