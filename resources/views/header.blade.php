                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <el-dropdown class="relative ml-3">
                            <button
                                ...
                                <img src="@php echo $user->profile_pic != "" ? $user->profile_pic : asset('imgs/profile.png') @endphp "
                                    alt="" class="size-8 bg-gray-200 rounded-full outline -outline-offset-1 outline-white/10" />
                            </button>
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
            ...
            <div class="border-t border-white/10 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img src="@php echo $user->profile_pic != "" ? $user->profile_pic : asset('imgs/profile.png') @endphp "
                            alt="" class="size-10 bg-gray-200 rounded-full outline -outline-offset-1 outline-white/10" />
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">@php echo $user->name; @endphp </div>
                        <div class="text-sm font-medium text-gray-400">@php echo $user->email; @endphp </div>
                    </div>
                    <button type="button"
