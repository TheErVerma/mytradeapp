...
<div class="global-popup" id="add-trade-popup" data_identity="add-trade-pop">
                ...
                <form action="" id="add_trade_popup" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="flex flex-col gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
                        ...
                        <div class="z-10 flex flex-col gap-1">
                            <p class="text-display-xs font-semibold text-primary">Add Trade</p>
                            <p class="text-sm text-tertiary">Add your latest trade to your journal. Fill in the
                                trade details to maintain an accurate trading history</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <button class="btn btn-md btn-primary" type="submit">
                            <span class="transition px-0.5">Add Trade</span>
                        </button>
                    </div>
